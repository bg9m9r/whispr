#!/usr/bin/env bash
# Publish Whispr server for a given runtime identifier.
# Usage: ./publish-server.sh <rid>
...
PROJECT="$REPO_ROOT/src/Whispr.Server/Whispr.Server.csproj"
PUBLISH_DIR="$REPO_ROOT/src/Whispr.Server/bin/Release/net10.0/$RID/publish"
DIST_DIR="$REPO_ROOT/dist"
ARCHIVE_NAME="whispr-server-$RID"
